  ...
  return (
    <div className= {styles.sugarFooterMainDiv}>
        <div className={styles.sugarLogoFooterHead}>
            <img className={styles.sugarLogoImageSet} src="" alt="sugar-cosmetics-logo" />
        </div>
        ...
        <div className={styles.sugarNewsLetterAndSugarApp}>
            ...
            <div className={styles.sugarAppNew}>
                ...
                <div className={styles.sugarAppNewInnerDiv}>
                    ...
                    <a className={styles.sugarAppPlayStoreAppleStore} href="" target={"blank"}><img className={styles.sugarAppPlayStoreAppleStore} src="https://in.sugarcosmetics.com/playstore.png" alt="" /> </a>
                    <a className={styles.sugarAppPlayStoreAppleStore} href="" target={"blank"}><img className={styles.sugarAppPlayStoreAppleStore} src="https://in.sugarcosmetics.com/apple-store.png" alt=""/></a>
                    </div>
                </div>
            </div>
        </div>
        <div className={styles.sugarInformation}>
            ...
            <div className={styles.sugarInformationInnerInfo}>
                <a href="" style={{textDecoration:"none",color:"grey", backgroundColor:"black"}} target={"blank"} ><p className={styles.ps}>Stores</p></a>
                <a href="" style={{textDecoration:"none",color:"grey",backgroundColor:"black"}} target={"blank"} ><p className={styles.ps}>Terms & Conditions</p></a>
                <a href="" style={{textDecoration:"none",color:"grey",backgroundColor:"black"}} target={"blank"} ><p className={styles.ps}>Return</p></a>
                <a href="" style={{textDecoration:"none",color:"grey",backgroundColor:"black"}} target={"blank"} ><p className={styles.ps}>FAQ's</p></a>
                <a href="" style={{textDecoration:"none",color:"grey",backgroundColor:"black"}} target={"blank"} ><p className={styles.ps}>About Us</p></a>
            </div>
        </div>
        <div className={styles.sugarGetInTouch}>
            ...
            <div className={styles.sugarGetInTouchInnerInfo}>
                ...
                <div className={styles.div}>
                    ...
                    <a href="" target={"blank"} style={{textDecoration:"none",backgroundColor:"black"}}>
